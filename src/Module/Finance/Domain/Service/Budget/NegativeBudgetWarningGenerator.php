...
namespace App\Module\Finance\Domain\Service\Budget;
...
final readonly class NegativeBudgetWarningGenerator implements WarningGenerationInterface
{
    ...
    public function generate(
        ...
        foreach ($warningSubjectIds as $warningSubjectId) {
            $this->warningRepository->add(new Warning(
                new Ulid(),
                new WarningSubject($warningSubjectId, WarningSubjectTypeEnum::BUDGET),
                WarningTypeEnum::NEGATIVE_BUDGET,
                $generatedAt,
            ));
        }
    }
